...
import com.ucu.shopping.Model.Cart;
import com.ucu.shopping.Prevalent.CartViewHolder;
import com.ucu.shopping.Prevalent.Prevalent;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        NextProcessBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                txtTotalAmount.setText("Total Price = PESOS"+String.valueOf(overTotalPrice));
